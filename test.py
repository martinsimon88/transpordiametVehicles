...
import math
import datetime
from grabscreen2 import grab_screen
import matplotlib.pyplot as plt
cap=cv2.VideoCapture('Transpordiamet.mpg')
#firebase=firebase.FirebaseApplication('https://major-f1a75.firebaseio.com/',None)
#print cap.set(3,640)
#print cap.set(4,480)
cap.set(1,500) #algusaeg
centerPositions=[]
global blobs
blobs=[]
INENTRY=0
...
out = cv2.VideoWriter('output.avi',fourcc, 15.0, (int(cap.get(3)),int(cap.get(4))))
